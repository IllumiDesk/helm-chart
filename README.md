...
| Jupyterhub.singleUser.cpu.gurantee                                         | CPU initially allocated for single user images                                                                                           | 0.2                                                                                 |
| Jupyterhub.singleUser.cpu.limit                                            | Max CPU that single user images can use                                                                                                  | 0.2                                                                                 |
