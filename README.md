...
| graderSetupService.graderCPU                                               | Provide CPU allocation for Grader Setup Service                                                                                          | 0.2                                                                                 |
| graderSetupService.graderSpawnerImage                                      | Grader Image Name                                                                                                                        | illumidesk/illumidesk-grader:latest                                                 |
| graderSetupService.graderSpawnerMEM                                        | Provide MEM allocation for Grader                                                                                                        | 0.2                                                                                 |
| graderSetupService.graderSpawnerCPU                                        | Provide CPU allocation for Grader                                                                                                       | 1Gi                                                                                 |
| graderSetupService.graderSpawnerStorage                                    | Provide storage capacity the Grader                                                                                                     | 2Gi                                                                                 |
| graderSetupService.graderMEM                                               | Provide Memory alloction for Grader Setup Service                                                                                        | 200Mi                                                                               |
...
| graderSetupService.StorageCapacity                                         | Provide storage capacity the Grader Setup Service can use                                                                                | 20Gi                                                                                |
| graderSetupService.StorageRequests                                         | Provide initial storage allocated for the Grader Setup Service                                                                           | 20Gi                                                                                |
...
| Jupyterhub.hub.image.name                                                  | Image for Jupyterhub Image from registry                                                                                                 | illumidesk/jupyterhub                                                               |
| Jupyterhub.hub.image.tag                                                   | Tag for Jupyterhub Image from registry                                                                                                   | latest                                                                              |
| Jupyterhub.hub.resources.requests.cpu                                      | Jupyterhub allocated cpu                                                                                                                | 0.5                                                                                 |
| Jupyterhub.hub.resources.requests.memory                                   | Jupyterhub allocated memory                                                                                                              | 1Gi                                                                                 |
...
| Jupyterhub.singleUser.cpu.gurantee                                         | CPU initially allocated for single user images                                                                                           | 0.5                                                                                 |
| Jupyterhub.singleUser.cpu.limit                                            | Max CPU that single user images can use                                                                                                  | 0.5                                                                                 |
| Jupyterhub.singleUser.image.name                                           | Name of Single User Image                                                                                                                | illumidesk/illumidesk-notebook                                                      |
| Jupyterhub.singleUser.image.tag                                            | Tag of Single user Image                                                                                                                 | latest                                                                              |
| Jupyterhub.singleUser.memory.gurantee                                      | Memory initially allocated for single user images                                                                                       | 200Mi                                                                               |
| Jupyterhub.singleUser.memory.limit                                         | Max Memory that can be allocated for single user images                                                                                  | 200Mi                                                                               |
