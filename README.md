...
| illumideskSettings.customAuthType                                          | The custom authentication type. Should be one of DUMMY, LTI11, LTI13, or AUTH0.                                                                                                               | DUMMY                                                                               |
| illumideskSettings.enabled                                                 | Enables the IllumiDesk settings ConfigMap                                                                                                                                                     | FALSE                                                                               |
| illumideskSettings.externalHost                                            | External Postgres host endpoint. If not set, both the JupyterHub and nbgrader services will use this endpoint instead of the default Postgres endpoint from the internal Postgres deployment. |                                                                                     |
| illumideskSettings.jupyterhubAPIToken                                      | Jupyterhub API Token                                                                                                                                                                         |                                                                                     |
| illumideskSettings.jupyterhubCryptKey                                      | Jupyterhub Crypt Key                                                                                                                                                                          |                                                                                     |
| illumideskSettings.lti13AuthorizeUrl                                       | LTI v1.3 authorization URL                                                                                                                                                                    |                                                                                     |
| illumideskSettings.lti13ClientId                                           | LTI v1.3 client id                                                                                                                                                                            |                                                                                     |
| illumideskSettings.lti13Endpoint                                           | LTI v1.3 endpoint URL                                                                                                                                                                         |                                                                                     |
| illumideskSettings.lti13TokenUrl                                           | LTI v1.3 token URL                                                                                                                                                                            |                                                                                     |
| illumideskSettings.ltiConsumerKey                                          | LTI v1.1 consumer key                                                                                                                                                                         |                                                                                     |
| illumideskSettings.ltiSharedSecret                                         | LTI v1.1 Shared Secret                                                                                                                                                                        |                                                                                     |
| illumideskSettings.oidcAuthorizeUrl                                        | OIDC authorization URL                                                                                                                                                                        | FALSE                                                                               |
| illumideskSettings.oidcCallbackUrl                                         | OIDC callback URL                                                                                                                                                                             | FALSE                                                                               |
| illumideskSettings.oidcClientId                                            | OIDC client id                                                                                                                                                                                | FALSE                                                                               |
| illumideskSettings.oidcClientSecret                                        | OIDC client secret                                                                                                                                                                            | FALSE                                                                               |
| illumideskSettings.oidcTokenUrl                                            | OIDC token URL                                                                                                                                                                                | FALSE                                                                               |
| illumideskSettings.oidcUserDataUrl                                         | OIDC userdata URL                                                                                                                                                                             | FALSE                                                                               |
| illumideskSettings.postgresDB                                              | Postgres Database                                                                                                                                                                             | illumidesk                                                                          |
| illumideskSettings.postgresGraderPassword                                  | Postgres Grader Password for Grader Setup Service                                                                                                                                             |                                                                                     |
| illumideskSettings.postgresGraderUser                                      | Postgres nbgrader username                                                                                                                                                                    | postgres                                                                            |
| illumideskSettings.postgresHubPassword                                     | Postgres Jupyterhub Password                                                                                                                                                                  |                                                                                     |
| illumideskSettings.postgresHubUser                                         | Postgres JupyterHub username                                                                                                                                                                  | postgres                                                                            |
| illumideskSettings.postgresPort                                            | Postgres Port                                                                                                                                                                                 | 5432                                                                                |
